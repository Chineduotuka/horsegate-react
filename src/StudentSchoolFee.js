...
const StudentSchoolFee = () => {
    ...
    const handlesubmit = (e) =>
    {
        ...
        let reg = {amount , email, callback};
        console.log(id)
        console.log(reg);

        fetch("https://localhost:7083/api/Payment/make-payment", {
            method: "POST",
            ...
            <div className="information-bar">
                ...
                <div className="form-container">
                    ...
                    <form className="form" onSubmit={handlesubmit}>
                        ...
                        <input className="inpute" type="text" placeholder="Email" name="email" value={email} onChange={e => emailchange(e.target.value)}></input>
